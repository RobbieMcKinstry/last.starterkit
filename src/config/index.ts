...
const PostgresConfig = Config.all({
  POSTGRES_USER: Config.withDefault(Config.nonEmptyString("USER"), "postgres"),
  POSTGRES_PASSWORD: Config.nonEmptyString("PASSWORD"),
  POSTGRES_HOST: Config.withDefault(Config.nonEmptyString("HOST"), "127.0.0.1"),
  POSTGRES_DATABASE: Config.withDefault(
    Config.nonEmptyString("DATABASE"),
    "postgres",
  ),
  POSTGRES_PORT: Config.withDefault(Config.number("PORT"), 5432),
  POSTGRES_SSL: Config.withDefault(Config.boolean("SSL"), false),
});
